  ...
  \resumeEmploymentListStart
    \resumeEmployment
      ...
      {암호화폐 트레이딩 봇 플랫폼 MVP 개발}{}
        \resumeItemListStart
            ...
            \resumeItem{일괄 주문 및 주문 직렬화를 위해 Kafka를 도입해 트레이딩 봇과 주문 처리 서비스간 통신 구현.}
            \resumeItem{트레이딩 봇 제어 간 REST 대비 통신 효율을 높이기 위해 gRPC를 도입하여 마이크로서비스 간 통신 지연 최소화함.}
    ...
    \resumeEmployment
      ...
      \resumeItemListStart
          ...
          \resumeItem{Femu를 이용해 여러 workload를 시험해가며 대규모 write()이 이루어지는 환경에서 iJournaling이 취약하다는 점을 파악함.}
    ...
    \resumeProject
      {Codedang (\href{https://github.com/skkuding/codedang}{github.com/skkuding/codedang})}
         ...
         \resumeItemListStart
          ...
          \resumeItem{Judger 서비스의 순차 채점 로직을 병렬화하고, NestJS ↔ RabbitMQ 통신을 비동기적으로 개선함.}
          \resumeItem{Judger 서비스에 스페셜 저지 기능을 추가함.}
         \resumeItemListEnd
